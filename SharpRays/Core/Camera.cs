namespace SharpRays.Core {
    ...
    internal class Camera {
        ...
        public Camera(
            ...
            var theta = verticalFOV * (float) Math.PI / 180;
            ...
            v = Vector3.Cross(w, u);
            lowerLeftCorner = origin - halfWidth * focusDistance * u - halfHeight * focusDistance * v -
                              focusDistance * w;
        ...
        public Ray GetRay(float s, float t) {
            var rd = lensRadius * Rand.RandomInUnitDisk();
            var offset = u * rd.X + v * rd.Y;
            var time = Time0 + Rand.Float * (Time1 - Time0);
