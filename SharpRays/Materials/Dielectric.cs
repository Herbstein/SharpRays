...
namespace SharpRays.Materials {
    ...
    internal class Dielectric : IMaterial {
        ...
        public bool Scatter(Ray inRay, HitRecord rec, ref Vector3 attenuation, ref Ray scattered) {
            ...
            Vector3 reflected = inRay.Direction.Reflect(rec.N);
            float niOverNt;
            ...
            if (Vector3.Dot(inRay.Direction, rec.N) > 0) {
                ...
                cosine = refractionIndex *
                         Vector3.Dot(inRay.Direction, rec.N) /
            ...
            double reflectProb = inRay.Direction.Refract(outwardNormal, niOverNt, ref refracted)
                                     ? Dielectric.Schlick(cosine, refractionIndex)
                                     : 1;
