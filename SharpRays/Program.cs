namespace SharpRays {
    ...
    internal class Program {
        private static Vector3 Color(Ray ray, IHitable world, int depth) {
            ...
            if (world.Hit(ray, 0.001f, float.MaxValue, ref rec)) {
                ...
                if (depth < 50 && rec.M.Scatter(ray, rec, ref attenuation, ref scattered)) {
                    return attenuation * Program.Color(scattered, world, depth + 1);
                }
        ...
        private static void Main() {
            ...
            IHitable world = Program.RandomScene();
            ...
            for (var x = 0; x < width; x++) {
                for (var y = 0; y < height; y++) {
                    ...
                    for (var s = 0; s < samples; s++) {
                        float u = (x + Rand.Float) / width;
                        float v = (y + Rand.Float) / height;
                        Ray ray = cam.GetRay(u, v);
                        color += Program.Color(ray, world, 0);
                    }
