        ...
        private static void Main() {
            ...
            var testList = new IHitable[] {
                ...
                new Sphere(
                           ...
                           100,
                           new Lambertian(new ConstantTexture(new Vector3(0.8f, 0.8f, 0)))),
            ...
            //var world = new HitableList(testList);
            ...
            for (var x = 0; x < width; x++) {
                for (var y = 0; y < height; y++) {
                    ...
                    color /= samples;
                    color = color.ProcessPiecewise(Mathf.Sqrt);
                    color = color.ProcessPiecewise(s => (int) (s * 255.99));
